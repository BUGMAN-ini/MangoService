...
using Mango.Services.ShoppingCart.API.Utility;
...
new Uri(builder.Configuration["ServiceUrls:CouponAPI"])).AddHttpMessageHandler<BackEndApiAccesAuthenticatorDelegate>(); ;
